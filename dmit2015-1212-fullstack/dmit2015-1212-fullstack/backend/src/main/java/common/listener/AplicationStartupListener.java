...
@WebListener
public class AplicationStartupListener implements ServletContextListener, HttpSessionListener, HttpSessionAttributeListener {

    @Inject
    private EmployeeRepository _employeeRepository;

    public AplicationStartupListener() {
    }

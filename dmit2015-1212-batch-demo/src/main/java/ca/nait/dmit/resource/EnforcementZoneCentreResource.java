...
public class EnforcementZoneCentreResource {
    ...
    @Path("{id}")
    @GET    // This method only accepts HTTP GET requests.
    public Response findEnforcementZoneCentreById(@PathParam("id") Long enforcementZoneCentreId) {
    ...
    public Response updateEnforcementZoneCentre(@PathParam("id") Long enforcementZoneCentreId, EnforcementZoneCentre updatedEnforcementZoneCentre) {

...
/**
 *
 * curl -k -i https://localhost:8443/dmit2015-1212-oe01-jaxrs-demo/webapi/helloworld -H 'Accept: text/plain'
 * curl -k -i -X GET https://localhost:8443/dmit2015-1212-oe01-jaxrs-demo/webapi/helloworld -H 'Accept: text/html'
 * curl -k -i -X GET https://localhost:8443/dmit2015-1212-oe01-jaxrs-demo/webapi/helloworld -H 'Accept: application/json'
 * curl -OJ -k -X GET https://localhost:8443/dmit2015-1212-oe01-jaxrs-demo/webapi/helloworld/image -H 'Accept: image/png'
 *
 */
@RequestScoped
@Path("/helloworld")
public class HelloWorldResource {
    ...
    public Response helloWorldHtml() {
        String message = "<p>Hello World from <strong>JAX-RS</strong></p>";
        return Response.ok(message).build();
    }
